Type is set in `rem` units and receives no default margin or padding. The type scale is easily applied via the `.f1` `.f2` `.f3` `.f4` `.f5` `.f6` and `.p` classes. To add whitespace, wrap your content in a `.text-content` class.
